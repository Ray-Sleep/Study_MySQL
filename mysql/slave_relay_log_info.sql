...
(
    ...
    Relay_log_name                               text collate utf8_bin                          null comment 'The name of the current relay log file.',
    Relay_log_pos                                bigint unsigned                                null comment 'The relay log position of the last executed event.',
    Master_log_name                              text collate utf8_bin                          null comment 'The name of the master binary log file from which the events in the relay log file were read.',
    ...
    Channel_name                                 varchar(64)                                    not null comment 'The channel on which the replica is connected to a source. Used in Multisource Replication'
        primary key,
    Privilege_checks_username                    varchar(32) collate utf8_bin                   null comment 'Username part of PRIVILEGE_CHECKS_USER.',
    ...
    Assign_gtids_to_anonymous_transactions_value text collate utf8_bin                          null comment 'Indicates the UUID used while generating GTIDs for anonymous transactions'
)
